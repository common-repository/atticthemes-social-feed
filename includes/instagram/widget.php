<?php
class AtticThemes_Instagram_Widget extends WP_Widget {
	...
	function __construct() {
		parent::__construct(
			'atsf_instagram', // Base ID
			__('AtticThemes: Instagram Feed', 'atsf'), // Name
			array( 'description' => __( 'With this widget you can list your latest Instagram posts.', 'atsf' ), ) // Args
		);
	}
	...
	public function widget( $args, $instance ) {
		...
		/* Add markup below */
		if( class_exists('AtticThemes_Instagram') && method_exists('AtticThemes_Instagram', 'shortcode') ) {
			echo AtticThemes_Instagram::shortcode( array(
